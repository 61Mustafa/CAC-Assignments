...
# ==========================================
echo "1/4 Verwijderen van Auto Scaling Stack (MyASGStack)..."
...
# ==========================================
echo "2/4 Verwijderen van Application Stack (MyAppStack)..."
...
# ==========================================
echo "3/4 Verwijderen van Data & Storage Stack (MyStorageStack)..."
...
# ==========================================
echo "4/4 Verwijderen van Fundament Stack (MyFundamentStack)..."
